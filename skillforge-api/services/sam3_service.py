...
SAM3_MAX_PROMPT_CHARS = 250  # CLIP text encoder ≈ 77 tokens; keep prompts concise
...
async def segment_concept(
    ...
    try:
        if len(text_prompt) > SAM3_MAX_PROMPT_CHARS:
            text_prompt = text_prompt[:SAM3_MAX_PROMPT_CHARS].rsplit(" ", 1)[0]
